...
import { NonEmptyBase64Schema, NonNegativeSafeIntegerSchema, PositiveSafeIntegerSchema } from './_shared'
import { DeviceIdSchema, DocIdSchema, MessageIdSchema } from './ids'
