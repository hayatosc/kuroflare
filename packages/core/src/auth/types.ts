import type { DeviceId, VaultId } from '../ids'
import type { DeviceTokenClaims, DeviceTokenScope } from '../token-schemas'
import type { RevokeDeviceResponse } from '../device-http'
import type { SetupExchangeResponse } from '../setup'
