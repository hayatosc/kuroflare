...
import { requestMissingRemoteTextFile } from '../host/files'
import { setOwnedPathMarker } from '../host/guards'
import { insertMetaFile, metaMap, updateMetaFile } from '../host/meta'
...
import { materializeMetaRenames, type MetadataMaterializationPort } from './materialize'
