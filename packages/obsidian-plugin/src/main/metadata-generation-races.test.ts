...
import type * as MetaModule from './meta'
...
import type { KuroflareRepairLogEntry, KuroflareSettings, LoadedTextDoc } from '../main-types'
import { adoptLocalFilesAfterRemoteMeta } from './file-tree'
import { insertMetaFile, metaMap, readMetaFile } from './meta'
